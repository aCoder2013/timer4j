package com.song.timer.support;
...
/**
 * Parser implement for cron expression
 *
 * <p>art of this mapping code has been kindly borrowed from <a href="http://spring.io/">Spring
 * Framework</a>.</p>
 *
...
public class CronParser {
	...
	private void parse(String expression) throws IllegalArgumentException {
		String[] fields = TextUtils.tokenizeToStringArray(expression, " ");
	...
	private String replaceOrdinals(String value, String commaSeparatedList) {
		String[] list = TextUtils.commaDelimitedListToStringArray(commaSeparatedList);
	...
	private void setNumberHits(BitSet bits, String value, int min, int max) {
		String[] fields = TextUtils.delimitedListToStringArray(value, ",");
		for (String field : fields) {
			if (!field.contains("/")) {
				...
				String[] split = TextUtils.delimitedListToStringArray(field, "/");
				if (split.length > 2) {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof CronParser)) {
			return false;
		}
		CronParser otherCron = (CronParser) other;
